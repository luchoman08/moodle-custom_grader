...
abstract class BaseAPIView extends Validable {
    ...
    /**
     * @var array $params The params sended to php via post
     */
    public $data;
    /**
     ...
     */
    function  get_required_data(): array {
        return array();
    }
    function valid(): bool {
        $this->clean_errors();
        $valid = true;
        $required_params = $this->get_required_data();
     ...
     */
    function execute($args = null, $data= array()) {
