...
define([
    ...
    function (
        ...
        function fix_categories_headers_after_item_delete(item_id) {
            var parent_category_id = get_parent_category_id(item_id);
         ...
         * @returns {*}
         */
        function get_parent_category_id(item_id) {
        ...
        function get_dom_th_item(item_id) {
            console.log(`${GRADE_ITEM_HEADERS_SELECTOR}[data-itemid="${item_id}"]`, 'selector for item');
        ...
        function make_element_add_button(element_id, element_name, element_type) {
            return $('<a/>',
                {
                    "class": 'add-component',
         ...
         * @returns {*|jQuery}
         */
        var make_element_delete_button = function (element_id, element_name, element_type) {
            return $('<a/>',
                {
        ...
        var make_item_delete_button = function (item_id, item_name) {
            return make_element_delete_button(item_id, item_name, wizard.ELEMENT_TYPES.ROW);
        };
        var make_item_add_button = function (item_id, item_name) {
            return make_element_add_button(item_id, item_name, wizard.ELEMENT_TYPES.ROW);
        };
        /**
         * @method validateNota
        ...
        function make_item_mini_menu_options(item_id, item_name) {
            return $('<div/>',
                ...
                .append(
                    make_element_delete_button(item_id, item_name)
                );
        }

        /**
         * Add a menu of options (delete, add
         */
